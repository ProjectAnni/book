...
响应内容包含当前仓库所有可用的 `catalog` 以及多专辑 `Catalog` 包含的 `Catalog` 列表，如下例：

```json
{
  // 所有可用的 Catalog
  "albums": ["KSLA-0178", "KSLA-0155", "KSLA-0156", "KSLA-0157", "KSLA-0158", "KSLA-0159", "TS-0003-01", "TS-0003-02"],
  // 对含有多张 Disc 的专辑，额外返回专辑 Catalog 与 Catalog 的映射
  // 请求音频和歌词时应使用 Catalog，即数组中的 Catalog 请求资源
  // 请求封面时，专辑 Catalog 也可以使用
  "discs": {
